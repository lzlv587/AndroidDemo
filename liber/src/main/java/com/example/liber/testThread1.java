...
public class testThread1 extends Thread {
    ...
    public testThread1(Handler handler){this.handler=handler;};
    @Override
    public void run() {
        ...
        if (result2==null)
            result2="begin";
        while (!result1.equals("欢迎使用【16027240023】")) {
            try {
               /* //登录部分
               //获取当前时间*/
        ...
        while (!result2.equals("预约失败，该座位已经被预约！")){
            ...
            seat.put("seat_id", "2084");//四楼200    2451   107.290   2101  /101 1 713
            ...
            if (result1.equals("欢迎使用【16027240023】")&&result2.equals("预约成功！")){
                Message m = new Message();
                m.what = 11;
                handler.sendMessage(m);
                break;
            }else if(result1.equals("欢迎使用【16027240023】")&&result2.equals("预约失败，该座位已经被预约！")){
                Message m = new Message();
                m.what = 42;
                handler.sendMessage(m);
