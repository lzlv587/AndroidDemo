...
public class testThreadyqc4 extends Thread {
    ...
    public testThreadyqc4(Handler handler){this.handler=handler;};
    @Override
    public void run() {
        ...
        if (result2==null)
        result2="begin";
        while (!result1.equals("欢迎使用【16081440024】")) {
            try {
               /* //登录部分
               //获取当前时间*/
        ...
        while (!result2.equals("预约失败，该座位已经被预约！")){
            ...
            Log.d(TAG, "run: ---------testdate------" + date);
                ...
                seat.put("seat_id", "2118");//四楼200    2451   107.290   2101  /101 1 713/二楼1    1301
            ...
            //Elements result = dc.select("a");
                ...
                if (result1.equals("欢迎使用【16081440024】")&&result2.equals("预约成功！")){
                    Message m = new Message();
                    m.what = 13;
                    handler.sendMessage(m);
                    break;
                }else if(result1.equals("欢迎使用【16081440024】")&&result2.equals("预约失败，该座位已经被预约！")){
                    Message m = new Message();
                    m.what = 44;
                    handler.sendMessage(m);

                }else if (result1.equals("欢迎使用【16081440024】")&&result2.equals("闭馆，请预约明天的座位！")){
                    Message m=new Message();
                    m.what=5;
                    handler.sendMessage(m);
                }
